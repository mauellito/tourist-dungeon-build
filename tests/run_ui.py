#!/usr/bin/env python3
"""TD_UI tests — presentation / quality-of-life logic (auto-explore, labels,
threats, --more-- gate, Bureau barks, the colour-discipline palette).

Concatenates engine/rng.js + interpreter.js + mapmode.js + generator.js + ui.js
with the test cases, runs TD_UI_TESTS() in headless Chrome, reports pass/fail.
Run:  python tests/run_ui.py
"""
import html
import os
import re
...
ENGINE_FILES = ["rng.js", "resolve.js", "burden.js", "interpreter.js", "vaults.js", "gen2.js", "mapmode.js", "generator.js", "ui.js"]
TESTS = os.path.join(ROOT, "tests", "ui.tests.js")
CHROME_CANDIDATES = [
...
(function(){
  ...
  try {
    ...
    document.title = 'TD_UI pass=' + r.pass + ' fail=' + r.fail;
  } catch (e) { out.textContent = 'HARNESS_ERROR ' + (e && e.stack ? e.stack : e); document.title = 'TD_UI harness_error'; }
})();
</script>
"""
...
def main():
    ...
    runner = os.path.join(TMPDIR, "ui_runner.html")
    with open(runner, "w", encoding="utf-8") as f:
        f.write("\n".join(parts))
    user_data = tempfile.mkdtemp(prefix="td_ui_")
