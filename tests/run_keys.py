...
F.onload = function(){
  ...
  try {
    ...
    var HANDLED = {lookout:1,agency:1,kiosk:1,hotel:1,guestfloor:1,spa:1,food:1,anchor:1,gate:1,rest:1,blessing:1,tim:1,boat:1,shop:1,vault:1,flavor:1,shrine:1,vice:1};
    ...
    D._setCreatures([]); D._meters().hp=90; D._meters().satiation=5.05;   // just above the 5% Starving line; one wait drains across (Gate 8.1 lower drain)
