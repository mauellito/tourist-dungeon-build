#!/usr/bin/env python3
"""TD_GAME tests (town + forks + signals + brass + postmortem + persistence).

Runs TD_GAME_TESTS() in headless Chrome against the real engine modules.
Run:  python tests/run_game.py
"""
import html
import os
import re
...
ENGINE_FILES = ["rng.js", "resolve.js", "stats.js", "charsys.js", "burden.js", "econ.js", "interpreter.js", "vaults.js", "gen2.js", "mapmode.js", "voices.js", "towngen.js", "generator.js", "game.js", "ui.js"]
TESTS = os.path.join(ROOT, "tests", "game.tests.js")
CHROME_CANDIDATES = [
...
(function(){
  ...
  try {
    ...
    document.title = 'TD_GAME pass=' + r.pass + ' fail=' + r.fail;
  } catch (e) { out.textContent = 'HARNESS_ERROR ' + (e && e.stack ? e.stack : e); document.title = 'TD_GAME harness_error'; }
})();
</script>
"""
...
def main():
    ...
    runner = os.path.join(TMPDIR, "game_runner.html")
    with open(runner, "w", encoding="utf-8") as f:
        f.write("\n".join(parts))
    user_data = tempfile.mkdtemp(prefix="td_game_")
